...
popd
if not exist "%GODOT%" (
  echo [02-V03-LaunchGame][ERROR] Godot not found at: %GODOT%
  exit /b 1
)
if not exist "%PROJ_ABS%\project.godot" (
  echo [02-V03-LaunchGame][ERROR] project.godot NOT FOUND under: %PROJ_ABS%
...
echo.
echo ====================================================
echo   V0.3 - Launch GAME (Player Mode)
...
set EC=%ERRORLEVEL%
echo.
echo [02-V03-LaunchGame] Exited. ExitCode=%EC%
endlocal
